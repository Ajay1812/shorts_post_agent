...
class FinalShort:
    ...
    def process(self, video_file_path: str, audio_file_path:str ,subtitle_file_path: str, temp_path: str, upload_shorts_path:str):
        ...
        final_output = os.path.join(upload_shorts_path, "final.mp4")
        command_subs = [
            "ffmpeg",
            "-i", temp_path,
            "-filter_complex",
            (
                ...
                f"subtitles={subtitle_file_path}:force_style='FontName=Roboto,FontSize=16,PrimaryColour=&HFFFFFF&,OutlineColour=&H000000&,BorderStyle=1,Outline=2,Shadow=1,Alignment=10'" \
            ),
            "-c:a", "copy",
            "-c:v", "libx264",
            "-crf", "23",
